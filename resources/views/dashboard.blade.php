        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mt-4">
            <div class="bg-amber-50 border border-amber-200 rounded-lg p-4 flex items-start gap-3">
                ...
                <div class="flex-1 text-sm text-amber-800">
                    <p class="font-semibold">Peringatan: Semester {{ $endingSoonPeriod->semester === 1 ? '1 (Ganjil)' : '2 (Genap)' }} {{ $endingSoonPeriod->tahun_ajaran }} akan berakhir dalam {{ $endingSoonPeriod->daysUntilEnd() }} hari.</p>
                    <p class="mt-1">Pastikan untuk mendownload rekap absensi sebelum data direset.</p>
                    <a href="{{ route('rekap.index') }}" class="mt-2 inline-flex items-center text-amber-700 font-medium underline hover:text-amber-900">Download Rekap Absensi →</a>
                </div>
            </div>
        </div>
    @endif
