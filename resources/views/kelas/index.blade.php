                        ...
                        @foreach ($kelas as $index => $k)
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-center border-b font-medium space-x-2 w-48">
                                    ...
                                    <button type="button" data-open-delete-modal data-delete-action="{{ route('kelas.destroy', $k->id) }}" aria-haspopup="dialog" aria-controls="global-delete-modal" class="text-red-600 hover:text-red-900 bg-red-50 px-3 py-1.5 rounded-md border border-red-200 transition">Hapus</button>
                                </td>
                            </tr>
                        @endforeach
                    </x-table>
