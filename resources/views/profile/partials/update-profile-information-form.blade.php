<section>
    ...
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            Perbarui nama, username, dan nomor telepon akun Anda.
        </p>
    </header>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="no_telepon" name="no_telepon" type="text" class="mt-1 block w-full" :value="old('no_telepon', $user->no_telepon)" placeholder="Contoh: 08123456789" autocomplete="tel" />
            <x-input-error class="mt-2" :messages="$errors->get('no_telepon')" />
            <p class="mt-1 text-xs text-gray-500">Format: 08xxx atau 62xxx (opsional)</p>
        </div>
