        ...
        <form method="POST" action="{{ route('guru.store') }}" data-guru-form class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <x-text-input id="username" name="username" type="text" class="mt-1 block w-full" :value="old('username')" placeholder="Contoh: ahmadfauzi" required />
            ...
            <div id="kelas-section" data-kelas-section class="bg-gray-50 p-4 rounded-md border border-gray-200">
                ...
                @if($kelas->isEmpty())
                    <p class="mt-2 text-xs text-gray-500">
                        Belum ada kelas yang tersedia. Kelas dapat ditambahkan setelah data guru dibuat.
                    </p>
                @endif
