            ...
            <div class="bg-gray-50 p-4 rounded-md border border-gray-200 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="nama_siswa" name="nama_siswa" type="text" class="mt-1 block w-full" :value="old('nama_siswa')" placeholder="Contoh: Ahmad Fauzi" required />
            ...
            <div class="bg-gray-50 p-4 rounded-md border border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <x-text-input id="nama_ayah" name="nama_ayah" type="text" class="mt-1 block w-full" :value="old('nama_ayah')" placeholder="Contoh: Budi Santoso" required />
                    ...
                    <div>
                        ...
                        <x-text-input id="no_whatsapp_ayah" name="no_whatsapp_ayah" type="text" class="mt-1 block w-full" :value="old('no_whatsapp_ayah')" placeholder="Contoh: 08123456789" />
                        <x-input-error class="mt-2" :messages="$errors->get('no_whatsapp_ayah')" />
                    </div>

                    <div>
                        <x-input-label for="nama_ibu" :value="__('Nama Ibu *')" />
                        <x-text-input id="nama_ibu" name="nama_ibu" type="text" class="mt-1 block w-full" :value="old('nama_ibu')" placeholder="Contoh: Siti Aminah" required />
                        <x-input-error class="mt-2" :messages="$errors->get('nama_ibu')" />
                    </div>

                    <div>
                        <x-input-label for="no_whatsapp_ibu" :value="__('No. WhatsApp Ibu (Opsional)')" />
                        <x-text-input id="no_whatsapp_ibu" name="no_whatsapp_ibu" type="text" class="mt-1 block w-full" :value="old('no_whatsapp_ibu')" placeholder="Contoh: 08123456789" />
