            ...
            <div class="bg-gray-50 p-4 rounded-md border border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="no_whatsapp_ayah" name="no_whatsapp_ayah" type="text" class="mt-1 block w-full" :value="old('no_whatsapp_ayah', $siswa->no_whatsapp_ayah)" required />
                    ...
                    <div>
                        ...
                        <x-text-input id="no_whatsapp_ibu" name="no_whatsapp_ibu" type="text" class="mt-1 block w-full" :value="old('no_whatsapp_ibu', $siswa->no_whatsapp_ibu)" required />
                        <x-input-error class="mt-2" :messages="$errors->get('no_whatsapp_ibu')" />
                    </div>

                    <div>
                        <x-input-label for="nama_wali" :value="__('Nama Wali (Opsional)')" />
                        <x-text-input id="nama_wali" name="nama_wali" type="text" class="mt-1 block w-full" :value="old('nama_wali', $siswa->nama_wali)" />
                    ...
                    <div>
                        ...
                        <x-text-input id="no_whatsapp_wali" name="no_whatsapp_wali" type="text" class="mt-1 block w-full" :value="old('no_whatsapp_wali', $siswa->no_whatsapp_wali)" />
