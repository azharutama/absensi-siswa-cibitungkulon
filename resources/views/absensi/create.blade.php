<x-app-layout>
    ...
    <div class="p-6 space-y-6">
        ...
        @if(auth()->user()->role === 'guru')
            <x-absensi-filter :action="route('absensi.create')" :kelas="$kelas" :kelasId="$kelasId" :tanggal="$tanggal" :hideKelas="true" :activeDates="$activeDates ?? []" />
        @else
            <x-absensi-filter :action="route('absensi.create')" :kelas="$kelas" :kelasId="$kelasId" :tanggal="$tanggal" :activeDates="$activeDates ?? []" />
        @endif
