...
Pengguna dapat memilih **Lupa kata sandi?** di halaman masuk dan memasukkan
nomor WhatsApp yang tersimpan pada akunnya. Aplikasi mengirim tautan reset yang
berlaku selama 60 menit melalui Fonnte. Pastikan `FONNTE_TOKEN` telah diisi,
perangkat WhatsApp Fonnte tersambung, dan `APP_URL` menggunakan alamat aplikasi
yang dapat dibuka dari perangkat penerima pesan.
